...
> **架构**: [`docs/architecture.md`](docs/architecture.md) · **IDA 数据**: [`docs/ida_analysis_results.md`](docs/ida_analysis_results.md) · **Mod 开发指南**: [`docs/mod-development-guide.md`](docs/mod-development-guide.md)
